...
//sgm
-(id)initWithAssetDictionary:(NSDictionary *)assetDic delegate:(NSObject<FGalleryPhotoDelegate> *)delegate{
    self = [super init];
    
    _useNetwork = NO;
    isAssetDic = YES;
    assetDictionary = [assetDic retain];
    _delegate = delegate;
    return self;
...
- (void)loadFullsizeInThread
{
    ...
    if (isAssetDic) {
        ALAsset* asset = [assetDictionary objectForKey:@"asset"];
        _fullsize = [[UIImage imageWithCGImage:[[asset defaultRepresentation] fullScreenImage]] retain];
...
- (void)loadThumbnailInThread
{
    ...
    if (isAssetDic) {
        ALAsset* asset = [assetDictionary objectForKey:@"asset"];
        _thumbnail = [[UIImage imageWithCGImage:[[asset defaultRepresentation] fullScreenImage]] retain];
